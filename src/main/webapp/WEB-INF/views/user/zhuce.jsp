		...
		<div class="wrap">
			<div class="main clearfix">
				...
				<c:if test="${not empty message}">
					<h3 style="color: red;padding-left: 150px">${message}</h3>
				</c:if>

				<form id="registerForm" action="/zhuce"   method="post">
					<table>
						<tbody><tr>
						...
						<tr>
							...
							<td>
								<input id="passwordtwo" type="password" name="passwordtwo" class="text" maxlength="20"/>
							</td>
						</tr>
						<tr>
							<th>
						...
						<tr>
							...
							<td>
								<input type="button" id="loginBtn" class="submit" value="同意以下协议并注册">
							</td>
						</tr>
						<tr>
							<th>&nbsp;
