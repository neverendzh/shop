...
<div class="container cart">
    ...
    <div class="span24">
        ...
        <table>
            ...
            <c:forEach items="${dindDanModels}" var="cs">
                <tr>
                    <td width="60">
        ...
        <div class="total">
            <em id="promotion"></em>
            待付金额: <strong id="effectivePrice">￥${countmoney}元</strong>
        </div>
        <form id="orderForm" action="/order_payOrder" method="post">
            <input type="hidden" name="order.oid" value=""/>
            <div class="span24">
                <input style="display: none" value="${countmoney}" name="total"/>
                <input style="display: none" value="${oid}" name="orderID"/>
                <p>
